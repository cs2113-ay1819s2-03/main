...
image::UndoRedoActivityDiagram.png[width="600"]
...
image::compareseq.png[width="600", title="Sequence Diagram for `compare` Command"]
...
image::compare1.png[width="600", title="Example of VersionedProject when `edit` on Task B"]
...
image::compare2.png[width="600", title="Process of how `compare` command will flow"]
...
image::taskhistoryseq.png[width="600", title="Sequence Diagram for `taskhistory` Command"]
...
image::ViewTaskHistorySeq1.png[width="600", title="Behaviour of userTaskHistoryTaskId during `add` commands"]
...
image::ViewTaskHistorySeq2.png[width="600", title="Behaviour of userTaskHistoryTaskId during `edit` commands"]
